...
| [`papers-to-read.bib`](https://github.com/shmuhammadd/missing-guide-nlp/blob/main/docs/examples/papers-to-read.bib) | BibTeX file of every paper cited in [Chapter 27](../chapters/27-best-papers.md). Drop into Overleaf. |
...
3. Add the BibTeX to `papers-to-read.bib` if the paper belongs in Chapter 27.
